---
layout: post
title: Reporting Ceph issues from the Ceph-Dashboard
date: 2021-08-21 13:32:20 +0200
description:  # Add post description (optional)
img: gsoc.png # Add image post (optional)
fig-caption: # Add figcaption (optional)
tags: [GSoC, Opensource, Ceph]
---
...
## About Ceph
Ceph is an open-source software storage platform, implements object storage on a single distributed computer cluster. Ceph uniquely delivers object, block, and file storage in one unified system. Ceph makes it easier to handle vast amounts of data.
...
![Issue Reporter Funnel]({{site.baseurl}}/assets/img/FunnelDiagram.jpg)
...
![Ceph User Workflow]({{site.baseurl}}/assets/img/workflow.jpg)
...
*This command can run without setting the API access key*
...
![Ceph Dashboard]({{site.baseurl}}/assets/img/dashboard.png)
...
[Issue description and discussion](https://tracker.ceph.com/issues/44851)   
[Backend PR](https://github.com/ceph/ceph/pull/42090)   
[Frontend PR](https://github.com/ceph/ceph/pull/42603)   

### Things left to do

1. Make the required changes in frontend PR
2. Shift the feedback to a new standalone mgr module
